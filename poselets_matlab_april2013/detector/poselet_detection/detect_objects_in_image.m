...
poselet_hits = detect_poselets(phog,model.svms,config);  % here we retain all the poselet hits.
...
% detected poselets are ranked by score.The score is directly from SVM
% detection
