...
workingDir=...
    ['/home/zhang/workspace/ActiveHogSVM/annotation/Dataset_RochesterADL/',...
    video];
...
for i = 1:N
    ...
    rect_head = head_detection(img,head_models);
    
    fprintf('-- poselet body detection...\n');
    [rect_person,rect_torso] = body_detection(img);
    toc;
...
function rect_head = head_detection(img,models)
...
function [rect_person,rect_torso] = body_detection(img)
