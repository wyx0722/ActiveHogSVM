#include <math.h>
#include "mex.h"
// This function was copied from exemplar-svm library and modified by yan zhang
// the original version see voc-release-3.1 or vlfeat library
...
// main function:
// takes a double grayscale image and a bin size (or cell size) 
